...
// const CreateStudent = ({ addStudent, mydata, errors }) => {
...
//             </div>
//             <input  type="file" aria-label="Choose file to upload" value={profile_image} disabled='' nChange={(e) => setProfile_image(e.target.files[0])}  className="flex-grow px-3 py-2 font-medium text-gray-300 bg-white text-ellipsis dark:bg-gray-900 dark:text-gray-300"/>
...
const DataForm = ({ mydata }) => {
  const [formData, setFormData] = useState({
    ...
    teacher_last_name: '',
    teacher_other_name: '',
    teacher_phone_number_1: '',
    teacher_phone_number_2: '',
    teacher_email: '',
    teacher_employment_type: '',
    teacher_home_address: '',
    teacher_local_government_area: '',
    teacher_state_of_origin: '',
    teacher_nin: '',
    teacher_bvn: '',
    teacher_staff_type: '',
    teacher_staff_id: '',
  ...
  const validateForm = () => {
    ...
    const requiredFields = [
      'first_name', 'last_name', 'date_of_birth', 'gender', 'type', 'home_address',
      'state_of_origin', 'local_government_area', 'nationality', 'parent_code', 
      'class_assigned', 'religion'
    ];
    ...
    // For example, validate email format or phone number length
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex  dashboard absolute bg-[#f5f9fc] top-[75px] left-[16%] p-[10px]">
      <div className="items-center justify-center w-[250px] h-[210px]">
          <label htmlFor="profile_img" className="flex flex-col items-center mb-[30px] justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              <svg className="w-8 h-8 mb-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
            ...
            <input type="file" aria-label="Choose file to upload"  id="profile_image" value={formData.profile_img} disabled="" onChange={handleFileChange} className="w-[107px] flex-grow font-medium px-3 py-2 text-ellipsis dark:bg-gray-900 text-gray-300 dark:text-gray-300"/>
      ...
      <button
        className="w-[99px] md:ml-[369px] mx-auto text-white bg-blue-700 mt-[70px] hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
        type="submit"
      >
        Submit
      </button>
