    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="flex">
        <div className="items-center justify-center w-[250px] h-[210px]">
          <label
            htmlFor="profile_img"
            className="flex flex-col items-center mb-[30px] justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50"
          >
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              <svg className="w-8 h-8 mb-4 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 16">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 13h3a3 3 0 0 0 0-6h-.025A5.56 5.56 0 0 0 16 6.5 5.5 5.5 0 0 0 5.207 5.021C5.137 5.017 5.071 5 5 5a4 4 0 0 0 0 8h2.167M10 15V6m0 0L8 8m2-2 2 2" />
            ...
            <input
              ...
              className="flex-grow px-3 py-2 font-medium text-gray-300 bg-white text-ellipsis dark:bg-gray-900 dark:text-gray-300"
            />
            {errors.profile_image && <p className="mt-1 text-sm text-red-500 ">{errors.profile_image}</p>}
          </label>
        </div>
